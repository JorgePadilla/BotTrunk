...
Environment:
  ...
  BOTTRUNK_MAX_PER_CALL    per-call cap in USDC (default 100000000000; "none" for no cap)
  BOTTRUNK_MAX_PER_DAY     per-day cap in USDC (default 100000000000; "none" for no cap)
