...
1. In Pera, switch the **gateway** account (`UTWS…MRE`) to MainNet, fund it with a few ALGO, **opt in to USDC `31566704`** (0.1 ALGO min balance + fee).
