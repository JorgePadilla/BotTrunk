...
Rails.application.configure do
  ...
  # Active Record encryption keys for development only (DepositOrder#account_number).
  # Production keys live in credentials: `bin/rails db:encryption:init`.
  config.active_record.encryption.primary_key = "development-primary-key-not-a-secret-0000000000"
  config.active_record.encryption.deterministic_key = "development-deterministic-key-not-a-secret-00"
  config.active_record.encryption.key_derivation_salt = "development-key-derivation-salt-not-a-secret"
end
